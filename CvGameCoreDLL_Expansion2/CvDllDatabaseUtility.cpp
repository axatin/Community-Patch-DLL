...
//------------------------------------------------------------------------------
unsigned int CvDllDatabaseUtility::GetReferenceCount() const
{
	return m_uiRefCount;
}
//------------------------------------------------------------------------------
...
{
	// This function changes the IDs in the database tables to make sure they start at 0 and there are no gaps

	std::set<CvString> sTablesToExclude;
	// to exclude a table from remapping, add it to this set
	// for example: 'TablesToExclude.insert("GreatWorkClasses");'
